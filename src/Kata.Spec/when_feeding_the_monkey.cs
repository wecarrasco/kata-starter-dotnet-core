...
namespace Kata.Spec
{
    ...
    public class when_user_input_has_newline_and_comma_as_delimiters
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        It should_split_and_return_the_sum_of_all_numbers = () => { _result.Should().Be(6); };
        private static Calculator _systemUnderTest;
        private static int _result;
    }

    public class when_user_input_is_multiple_numbers_with_a_custom_delimeter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        It should_sum_all_the_numbers = () => { _result.Should().Be(3); };
        private static Calculator _systemUnderTest;
        private static int _result;
    }
}
